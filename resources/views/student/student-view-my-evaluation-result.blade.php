        ...
        <div class="col-md-9 bg-white">
            <div class="container-fluid mt-2">
                <div class="row">
                    <div class="col-md-12 ">
                        <br>
                        <h4 class="border-bottom pl-2">My Courses Evaluation Result</h4>
                    </div>
                </div>
                        ...
                        <div class="light-font secondary-color">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb ">
                                    ...
                                    <li class="breadcrumb-item active"><i class="fa fa-files-o" aria-hidden="true"></i> My Classes Tests Result</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h5 class="pt-2 pl-2 text-center">List of my Classes</h5>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        @foreach ($myclasses as $mc)
                                            <tr>
                                                ...
                                                <td>{{$mc->schedule}}</td>
                                                <td>{{(isset($countQuizzesResult))?$countQuizzesResult:''}}</td>
                                                <td>{{(isset($countExamResult))?$countExamResult:''}}</td>
                                                
                                                <td>
                                                    <a href="{{route('viewClassEvalResult',['classid'=>$mc->cpo_id])}}"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
