        ...
        <div class="col-md-3 bg-faded" id="">
            <div class="row">
                <div class="col-md-3 position-fixed mt-2" id="sticky-sidebar">
                    <h3 class="text-center border-bottom border-secondary p-2"><a href="{{route('studentdashboard')}}" class="text-reset text-decoration-none"><i class="fa fa-tachometer" aria-hidden="true"></i> {{$deptCode}}</a></h3>
            ...
            <div class="container-fluid mt-2">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 offset-2 mt-4">
                        <div class="col-md-12">
                            <form action="{{route('submitChangePasswordStud')}}" method="POST">
                                {{ csrf_field() }}
