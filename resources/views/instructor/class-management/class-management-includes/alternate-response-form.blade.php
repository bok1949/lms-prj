<div class="row">
    <div class="col-md-3">{{-- Card Counting Questions Made --}}
        <div class="card">
            ...
            <div class="card-footer">Number of Item/s:  <span id="numitems_ar"></span></div>
            <div class="card-footer">Total Points: <span id="totalpoints_ar"></span></div>
        </div>
    </div>{{-- End of Card Counting Questions Made --}}
    <div class="col-md-9">
        <div class="card">{{-- qctr --}}
            <div class="card-header bg-secondary text-white qdeschead">Question <span id="eqctr_ar"></span></div>
            <form action="" class="alternateResponse">
                <div class="card-body">
                    {{ csrf_field() }}
                    <input type="hidden" name="einstruct_id" value="">
                    <input type="hidden" name="examtype" value="ar">
                    <input type="hidden" name="examtype_ei" value="arei1">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="number" name="pointsar" min="1" class="form-control">
                            </div>
                        </div>
                ...
                <div class="card-footer">
                    <div class="form-group col-md-6 offset-3">
                        <button type="button" class="btn btn-secondary form-control" id="saveExamAR"><i class="fa fa-floppy-o" aria-hidden="true"></i> Save</button>
                    </div>
                </div>
            </form>
        </div>
